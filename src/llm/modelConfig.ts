...
// bundled as an Xcode resource instead and referenced by filename here.
// Add the file to the Xcode project as a bundle resource (drag into the
// project, check "Copy items if needed" + the app target's "Copy Bundle
